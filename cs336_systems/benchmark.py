...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Whether to measure only forward pass, or both forward and backward passes.",
    )
    parser.add_argument(
        "--loss",
...
def main() -> None:
    ...
    def run_step() -> tuple[float, float | None]:
